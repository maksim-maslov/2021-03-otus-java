...
- большие сборки мусора запускались меньшее количество раз чем при SerialGC и ParallelGC
- общее время на сборки меньше чем при SerialGC и примерно равное с ParallelGC, при этом время работы приложения дольше на 20% по сравнению с ParallelGC. 